...
- [X] T001 Create order models matching the 008 contract in `frontend/petstore-ui/src/app/orders/order.models.ts`
- [X] T002 Create `OrderApiService` (place, list, getById, normalized errors) in `frontend/petstore-ui/src/app/orders/order-api.service.ts`
...
- [X] T007 [US2] Create order list component (id, date, total, status badge, empty state) in `frontend/petstore-ui/src/app/orders/order-list.component.ts`

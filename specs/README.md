...
| 004 | [Customer accounts & sign-in](004-customer-accounts/spec.md) | Backend API | Spec draft | 002 |
| 005 | [Account UI](005-account-ui/spec.md) | UI | Spec draft | 003, 004 |
| 006 | [Shopping cart](006-shopping-cart/spec.md) | Backend API | Spec draft | 002 (anonymous carts), 004 (customer carts) |
| 007 | [Cart UI](007-cart-ui/spec.md) | UI | Spec draft | 003, 006 |
| 008 | [Checkout & orders](008-checkout-orders/spec.md) | Backend API | Spec draft | 004, 006 |
| 009 | [Checkout & order history UI](009-checkout-ui/spec.md) | UI | Spec draft | 005, 007, 008 |
| 010 | [Order processing & approval](010-order-processing/spec.md) | Backend | Spec draft | 008 |
| 011 | [Supplier fulfillment](011-supplier-fulfillment/spec.md) | Backend | Spec draft | 010 |
| 012 | [Admin orders & inventory UI](012-admin-ui/spec.md) | UI | Spec draft | 010, 011 |

...
- [ ] T001 Add `dotnet/Petstore.Tests/Petstore.Tests.csproj` test project with xUnit, `Microsoft.AspNetCore.Mvc.Testing`, and project reference to `dotnet/Petstore/Petstore.csproj`
- [ ] T002 Add `dotnet/Petstore.Tests` to `dotnet/Petstore/Petstore.slnx`
